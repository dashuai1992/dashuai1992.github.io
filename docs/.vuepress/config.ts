...
const DOMAIN_NAME = 'why1024.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    // repo: 'github.com/dashuai1992', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'yds', // 必需
      link: 'https://github.com/dashuai1992', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:dashuai1992@live.com',
        },
        {
        ...
        },
        {
          ...
          title: 'bilibili',
          link: 'https://space.bilibili.com/326277976',
        }
      ],
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '个人技术博客,后端,前端,后端开发,后端框架,数据库,服务器,算法,网络技术,技术文档,学习,面试,java,mysql,spring,JavaScript,js,vue,git,github,markdown',
      },
    ],
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '60b1962097f74eb9c5cb',
          clientSecret: '6cc6403523b1336cb5a1c688102602cce0b3a42d',
          repo: 'dashuai1992.github.io', // GitHub 仓库
          owner: 'dashuai1992', // GitHub仓库所有者
          admin: ['dashuai1992'], // 对仓库有写权限的人
